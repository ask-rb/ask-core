# MASTER_GOAL.md — ask-core

## Purpose

This is the **master goal** for building ask-core. It does not implement the gem
directly. It loads and follows the detailed build plan at:

> **GOAL.md:** `/Users/kaka/Code/ask-rb/ask-core/GOAL.md`
...
- **Source:** `/Users/kaka/Code/ask-rb/ask-core/lib/`
- **Tests:** `/Users/kaka/Code/ask-rb/ask-core/test/`
- **Goal:** `/Users/kaka/Code/ask-rb/ask-core/GOAL.md`
- **Remote:** `git@github.com:ask-rb/ask-core.git`
- **RubyLLM models:** /Users/kaka/Code/ask-rb/ruby_llm/lib/ruby_llm/models.rb for the models.dev integration pattern
- **RubyLLM provider:** /Users/kaka/Code/ask-rb/ruby_llm/lib/ruby_llm/provider.rb for the provider interface pattern
- **RubyLLM chat:** /Users/kaka/Code/ask-rb/ruby_llm/lib/ruby_llm/chat.rb for conversation/streaming patterns
- **llm-proxy protocols:** /Users/kaka/Code/ask-rb/llm-proxy/lib/llm_proxy/protocols/ for wire format normalization
...
The GOAL.md at `/Users/kaka/Code/ask-rb/ask-core/GOAL.md` contains the full
...
See the bottom of `/Users/kaka/Code/ask-rb/ask-core/GOAL.md` for the full checklist.
